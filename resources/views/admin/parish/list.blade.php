                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($parish_list as $parish)
                                        <tr>
                                            ...
                                            <td>{{$parish['diocese']->diocese_name}}</td>
                                            <td>{{$parish['parish_name']}}</td>
                                            <td>@if($parish['active'] == true) Active @else Inactive @endif </td>
                                            <td>
                                                <a href="{{ url('/admin/business/edit/' . $parish['id'] . '') }}" class="btn-sm btn-primary btn-xs" title="Edit Category" >
                                                    <span class="fas fa-edit" aria-hidden="true"/></a>
                                                {!! Form::open([
                                                        'method'=>'DELETE',
                                                        'url' => ['/admin/business', $parish['id']],
